...
instagram:
  format: table
  hook: "Calendário de vacinas do SUS no 1º ano"
  slides:
    - label: "Ao nascer"
      items: ["BCG — tuberculose grave", "Hepatite B (1ª dose)"]
    - label: "2 meses"
      items: ["Pentavalente (1ª)", "VIP — pólio (1ª)", "Pneumocócica 10 (1ª)", "Rotavírus (1ª)"]
    - label: "3 meses"
      items: ["Meningocócica C (1ª)"]
    - label: "4 meses"
      items: ["Pentavalente (2ª)", "VIP — pólio (2ª)", "Pneumocócica 10 (2ª)", "Rotavírus (2ª)"]
    - label: "5 meses"
      items: ["Meningocócica C (2ª)"]
    - label: "6 meses"
      items: ["Pentavalente (3ª)", "VIP — pólio (3ª)", "Influenza (campanha anual)"]
    - label: "9 meses"
      items: ["Febre amarela (1ª dose)"]
    - label: "12 meses"
      items: ["Tríplice viral (sarampo, caxumba, rubéola)", "Pneumocócica 10 (reforço)", "Meningocócica C (reforço)"]
faq:
  ...
  - question: "Febre depois da vacina é normal?"
    answer: "Sim, febre baixa a moderada (até 38,5°C) nas primeiras 24-48h é uma reação esperada — sinal de que o sistema imune está respondendo. Se houver febre instalada ou desconforto, converse com o pediatra sobre o que fazer — não medique por conta própria. A SBP e a OMS NÃO recomendam dar remédio 'preventivo' antes ou logo após a vacina, porque pode reduzir a resposta imune."
...
**Rotavírus** (oral, em gotas). Protege contra a **gastroenterite por rotavírus**, que era a principal causa de diarreia grave e desidratação em bebês antes da vacina. Há uma janela de idade rígida: a **1ª dose entre 1 mês e 15 dias e 3 meses e 15 dias**; a **2ª entre 3 meses e 15 dias e 7 meses e 29 dias**. **Doses fora dessa janela não podem ser dadas** (risco de invaginação intestinal aumenta). Por isso, atrasar essa vacina pode significar perdê-la para sempre — não dá para "atualizar depois". Se o bebê **golfar ou vomitar logo após** a dose oral, a orientação do PNI é **NÃO repetir** a aplicação no mesmo atendimento; a próxima dose segue o calendário normal.
...
| Febre até 38,5°C | Sim, em até 30% das doses | Conforto e hidratação; remédio só com orientação do pediatra |
...
- **Febre acima de 39,5°C** ou que não cede com as medidas orientadas pelo pediatra
...
- **"Remédio antes da vacina previne febre"** — Não recomendado. Estudos mostraram que medicar preventivamente **reduz a resposta imune** a algumas vacinas. Se a febre aparecer, fale com o pediatra.
