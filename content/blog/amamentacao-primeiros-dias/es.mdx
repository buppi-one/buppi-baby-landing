...
Ofrecer **biberón o chupete** demasiado pronto (antes de las 4 semanas, antes de que la lactancia esté bien establecida) puede llevar al bebé a rechazar el pecho o "olvidar" el agarre correcto. Si es realmente necesario complementar, prefiere **vasito, jeringa-cuchara o relactador** bajo orientación. Y si la fórmula es el complemento, la [tabla de cantidad por edad](/es/blog/cantidad-de-formula-por-edad/) ayuda a saber cuánto ofrecer.
