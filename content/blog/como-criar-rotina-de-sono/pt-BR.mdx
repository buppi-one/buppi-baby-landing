...
instagram:
  format: steps
  hook: "A rotina da noite em 5 passos"
  slides:
    - label: "Sinal de transição"
      items: ["Baixe as luzes, diminua o barulho e desligue as telas — o corpo entende que a noite começou."]
    - label: "Jantar ou mamada"
      items: ["A última refeição ou mamada do dia, com calma e sem pressa."]
    - label: "Higiene"
      items: ["Banho (nos dias em que houver) ou troca de fralda, pijama e escovar a gengiva ou os dentinhos."]
    - label: "Conexão calma"
      items: ["Um ou dois livros, uma canção de ninar, um tempinho de colo no escuro."]
    - label: "Berço"
      items: ["Coloque o bebê no berço ainda acordado e repita a mesma frase ou gesto de sempre: 'boa noite, hora de dormir'."]
faq:
