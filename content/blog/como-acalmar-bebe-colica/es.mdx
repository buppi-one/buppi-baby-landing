...
faq:
  ...
  - question: "¿Los probióticos funcionan de verdad?"
    answer: "Para bebés amamantados, sí. Una metaanálisis de 2018 (Sung et al., Pediatrics) con datos individuales de 4 ensayos clínicos mostró que una cepa específica de probiótico reduce significativamente el tiempo de llanto. Para bebés con fórmula, la evidencia aún es insuficiente. Esta guía no indica productos ni dosis — si tiene sentido para tu bebé, es el pediatra quien lo indica."
  - question: "¿Puedo dar algún medicamento o infusión para el cólico?"
    answer: "No por tu cuenta. Esta guía no indica medicamentos: las gotas 'para los gases' de venta libre no tienen eficacia comprobada más allá del placebo, y cualquier medicamento solo debe entrar con indicación del pediatra. Las infusiones (incluyendo hinojo, manzanilla y similares) NO son recomendadas por las principales sociedades pediátricas para menores de 6 meses — sustituyen volumen de leche, interfieren con la lactancia y pueden conllevar riesgos. Evítalas."
...
- **Gotas "para los gases" de venta libre**: estudios aleatorizados muestran solo efecto placebo. No uses nada sin indicación del pediatra.
- **Medicamentos "para el cólico" sin receta**: nunca uses sin prescripción. Varios están contraindicados a esta edad.
...
- Una **cepa específica de probiótico** **reduce significativamente** el tiempo de llanto en bebés con cólicos
...
En otras palabras: hay evidencia, pero para una cepa específica, en bebés amamantados — y esta guía no indica productos ni dosis. Si los cólicos son intensos, es el pediatra quien valora si tiene sentido y qué usar.
