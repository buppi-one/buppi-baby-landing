...
faq:
  ...
  - question: "Probióticos funcionam mesmo?"
    answer: "Para bebês amamentados, sim. Uma meta-análise de 2018 (Sung et al., Pediatrics) com dados individuais de 4 ensaios clínicos mostrou que uma cepa específica de probiótico reduz significativamente o tempo de choro. Para bebês em fórmula, a evidência ainda é insuficiente. Este guia não indica produtos nem doses — se fizer sentido para o seu bebê, é o pediatra quem indica."
  - question: "Posso dar algum remédio ou chá para a cólica?"
    answer: "Não por conta própria. Este guia não indica medicamentos: as gotas 'para gases' vendidas sem receita não têm eficácia comprovada além do placebo, e qualquer remédio só deve entrar com indicação do pediatra. Já chás (incluindo erva-doce, camomila e funcho) NÃO são recomendados pela Sociedade Brasileira de Pediatria para bebês menores de 6 meses — substituem volume de leite, atrapalham a amamentação e podem oferecer riscos. Evite."
...
- **Gotas "para gases" vendidas sem receita**: estudos randomizados mostraram efeito apenas placebo. Não use nada sem indicação do pediatra.
- **Remédios "para cólica" de farmácia**: nunca use sem prescrição. Vários têm contraindicação para essa idade.
...
- Uma **cepa específica de probiótico** **reduz significativamente** o tempo de choro em bebês com cólica
...
Em outras palavras: existe evidência, mas ela vale para uma cepa específica, em bebês amamentados — e este guia não indica produtos nem doses. Se a cólica está intensa, é o pediatra quem avalia se faz sentido e o que usar.
