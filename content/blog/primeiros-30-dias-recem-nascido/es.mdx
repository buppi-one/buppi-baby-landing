...
faq:
  ...
  - question: "¿Cuándo se cae el cordón umbilical?"
    answer: "Normalmente entre los 5 y 15 días de vida, aunque puede tardar hasta unas 3 semanas, lo que también es normal. Mantén la zona limpia y seca, déjala al aire y dobla el pañal por debajo del cordón. Acude al pediatra si hay enrojecimiento en la piel de alrededor, secreción con pus, mal olor o sangrado que no para."
...
Las **primeras vacunas** — **hepatitis B** (y **BCG** en los países donde se administra) — suelen ponerse ya en la maternidad. Confirma con el equipo qué pruebas y vacunas se hicieron y qué queda pendiente, y lleva la cartilla de salud del niño a cada consulta — ahí queda todo registrado.
