...
faq:
  ...
  - question: "When does the umbilical cord stump fall off?"
    answer: "Typically between 5 and 15 days of life, though it can take up to about 3 weeks, which is also normal. Keep the area clean and dry, let it air out, and fold the diaper down below the stump. See your pediatrician if there is redness on the surrounding skin, pus-like discharge, a strong odor, or bleeding that won't stop."
...
The **umbilical cord** stump dries and falls off on its own between day 5 and day 15 — sometimes up to about 3 weeks, which is also normal. Until then:
...
Still in the maternity ward and in the first days, your baby goes through **newborn screening** — the tests that catch early problems that show no symptoms at first:
...
The **first vaccines** — **hepatitis B** (and **BCG** in countries where it's given) — are generally administered right in the maternity ward. Confirm with the team which tests and vaccines were done and what's still pending, and bring your child's health record to every visit — that's where everything is logged.
...
- **A fever of 100.4°F / 38°C or higher** (rectal is the gold-standard reading; any fever in a baby under 3 months is an emergency)
