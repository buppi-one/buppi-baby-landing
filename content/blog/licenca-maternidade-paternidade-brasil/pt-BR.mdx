...
instagram:
  format: table
  hook: "Licença e salário-maternidade"
  slides:
    - label: "Licença-maternidade (CLT)"
      items: ["120 dias; 180 na Empresa Cidadã"]
    - label: "Licença-paternidade"
      items: ["5 dias hoje; sobe até 20 em 2029"]
    - label: "Estabilidade da gestante"
      items: ["Da confirmação até 5 meses após o parto"]
    - label: "Autônoma / MEI"
      items: ["Salário-maternidade sem carência desde 2024"]
    - label: "Valor (MEI e rural)"
      items: ["1 salário mínimo (R$ 1.621,00)"]
    - label: "Gêmeos ou mais"
      items: ["A licença não dobra: 120 ou 180 dias"]
faq:
