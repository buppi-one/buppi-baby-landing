...
instagram:
  format: table
  hook: "Marcos aos 12 meses"
  slides:
    - label: "Social e emocional"
      items: ["Brinca de 'cadê? achou!'"]
    - label: "Linguagem"
      items: ["Dá tchau", "Chama pai/mãe por um nome especial", "Entende o 'não'"]
    - label: "Cognitivo"
      items: ["Coloca um objeto dentro de um pote", "Procura objetos que viu você esconder"]
    - label: "Motor"
      items: ["Fica de pé se puxando", "Anda segurando nos móveis", "Bebe de copo sem tampa", "Pega coisas pequenas com a pinça"]
faq:
