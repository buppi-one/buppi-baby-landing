...
- Se usa **fórmula**, confira o preparo (diluição correta) com o pediatra; em alguns casos ele pode sugerir uma fórmula espessada (anti-refluxo/AR) — mas só com orientação, porque ela pode causar prisão de ventre ou ganho de peso além do necessário
