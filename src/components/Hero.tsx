        ...
        <div className="relative flex justify-center">
          ...
          <div className="relative w-full max-w-[400px]">
            <img
              alt={m.imageAlt}
              src="/hero.webp"
              srcSet="/hero-400.webp 400w, /hero-600.webp 600w, /hero.webp 800w"
              sizes="(min-width: 1024px) 400px, min(100vw, 400px)"
              width={800}
              height={800}
              fetchPriority="high"
              decoding="async"
              className="w-full h-auto rounded-[3rem] shadow-2xl border-8 border-white dark:border-slate-800 rotate-3 hover:rotate-0 transition-transform duration-500"
            />
            <div className="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700 max-w-[200px]">
              <div className="flex items-center gap-2 mb-2">
                <Icon name="wb_sunny" className="text-accent text-sm" />
